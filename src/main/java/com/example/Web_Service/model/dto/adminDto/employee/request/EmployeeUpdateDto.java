package com.example.Web_Service.model.dto.adminDto.employee.request;
...
public class EmployeeUpdateDto {
    ...
    public EmployeeUpdateDto(String name, String username, String password, String email, String phone, RoleEmployee role, Integer salary, Integer bonus) {
        this.name = name;
