package com.example.Web_Service.model.dto.adminDto.employee;
...
public class EmployeeDto {
    ...
    public EmployeeDto(String name, String username, String password, String email, String phone, RoleEmployee role, int salary, int bonus) {
        this.name = name;
