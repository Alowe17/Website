package com.example.Web_Service.model.dto.adminDto.user.request;
...
public class UserUpdateDto {
    ...
    public UserUpdateDto(String name, String username, String email, String phone, Role role, int balance) {
        this.name = name;
