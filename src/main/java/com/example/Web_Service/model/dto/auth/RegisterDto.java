package com.example.Web_Service.model.dto.auth;
...
public class RegisterDto {
    ...
    public RegisterDto(String name, String username, String password, String email, String phone, LocalDate birthdate) {
        this.name = name;
